...
this.setFreeRounds = function(freeRounds)
    ...
    this.initAssets = function()
    {
        ...
        this.insufficientFundsTxt.m_Color = '#ffffff';
...
//					this.autoPlayGamesRemainingMeter.draw(ctx);
            ...
            case 1:
                ...
                ctx.drawImage(this.imgElements, 17, 171, 248, 94, 42  + this.layout.PANEL.x, 180 + this.layout.PANEL.y, 248, 94);
                ctx.drawImage(this.imgElements, 17, 171, 248, 94, 337 + this.layout.PANEL.x, 180 + this.layout.PANEL.y, 248, 94);
                ctx.drawImage(this.imgElements, 17, 171, 248, 94, 632 + this.layout.PANEL.x, 180 + this.layout.PANEL.y, 248, 94);

                ctx.drawImage(this.imgElements, 283, 73,  178, 80, 668 + this.layout.PANEL.x, 80 + this.layout.PANEL.y, 178, 80);	// autoplay
                ctx.drawImage(this.imgElements, 283, 154, 187, 99, 75 + this.layout.PANEL.x, 70 + this.layout.PANEL.y, 187, 99);  // lines
                ctx.drawImage(this.imgElements, 285, 255, 96, 69, 412 + this.layout.PANEL.x, 85 + this.layout.PANEL.y, 96, 69);	// bet
